...
int main(int argc, char* argv[]){
 ...
 //  printf("(e) Module works with testcases 2,3 and 4 only\n");
	// printf("(f) Parse tree could not be constructed\n\n");
	...
	while(1){
		...
		printf("0: Exit\n");
		printf("1: Removal of comments - print the comment free code on the console\n");
		printf("2: Printing the token list generated by the lexer\n");
		printf("3: Parsing to verify the syntactic correctness of the input source code and print the parse tree\n");
		printf("4: Printing the total time taken by our stage 1 code of lexer and parser to verify the syntactic correctness\n");
        ...
        start_time = clock();
				...
				while((token = getNextToken(&fp)) != NULL) {
					...
					// printf("_______________________________________________________\n");
          printf("Line no. %d  Lexeme %s    Token  %s\n",token->line_no,token->lexeme,tokenMap2[token->type]);
					if (fp == NULL) {
